export const materiaColors: Record<string, string> = {
    ...
    portugues: "bg-purple-100 text-purple-700 border-purple-200",
    fisica: "bg-orange-100 text-orange-700 border-orange-200",
    quimica: "bg-green-100 text-green-700 border-green-200",
    biologia: "bg-cyan-100 text-cyan-700 border-cyan-200",
    historia: "bg-red-100 text-red-700 border-red-200",
    geografia: "bg-lime-100 text-lime-700 border-lime-200",
    redacao: "bg-pink-100 text-pink-700 border-pink-200",
    revisao: "bg-slate-100 text-slate-700 border-slate-200",
}
